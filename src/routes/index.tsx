    ...
    <div className="bg-background min-h-screen">
      ...
      <div className="bg-primary text-primary-foreground py-2 border-b border-border/10">
        <div className="container-page flex flex-col md:flex-row items-center text-xs font-semibold tracking-wide gap-3">
          <span className="bg-background text-primary px-3 py-1 rounded-sm uppercase animate-pulse shrink-0">
            Flash Info
          </span>
          <p className="text-center md:text-left w-full leading-relaxed">
            La 16ème édition des Blues du Fleuve annoncée sous le signe de l'intégration et de
            l'environnement. Découvrez le programme complet.
          </p>
        </div>
      </div>
      ...
      <section className="relative border-b border-border overflow-hidden">
        ...
        <div className="container-page py-20 md:py-28 relative text-white">
          ...
          <p className="mt-6 max-w-2xl text-lg text-white/90">
            ...
            espaces de création, de formation et de dialogue pour les artistes, porté par la vision
            de Baaba Maal.
          </p>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          <div className="order-2 md:order-1">
            ...
            <div className="space-y-6 font-serif text-muted-foreground text-lg leading-relaxed">
              <p>
                Né le 12 novembre 1953 à Podor, Mamadou Aliou Bah, dit <strong>Baaba Maal</strong>,
                est l'un des artistes africains les plus reconnus internationalement. Fils d'un
                pêcheur de l'ethnie Haalpulaar, il a grandi immergé dans la richesse musicale et
                spirituelle de la vallée du fleuve Sénégal, bercé par les chants du Fouta et les
                rythmes des griots de sa ville natale.
              </p>
              <p>
                Après des études musicales à Dakar, notamment à l'École Nationale des Arts, il
                poursuit sa formation au Conservatoire National de Musique de Paris, où il acquiert
                une maîtrise académique de la musique tout en restant profondément ancré dans ses
                racines. C'est là qu'il approfondit sa réflexion sur la valorisation des musiques
                traditionnelles d'Afrique de l'Ouest.
              </p>
              <p>
                De retour au Sénégal, Baaba Maal forme avec son ami d'enfance Mansour Seck, musicien
                non-voyant, le duo fondateur de sa carrière. Ensemble, ils sillonnent les villages
                du Fouta Toro, collectant chansons, mélodies et instruments traditionnels, travail
                ethnomusicologique d'une importance capitale pour la préservation du patrimoine
                musical Haalpulaar.
              </p>

              <div>
                <h4 className="font-display text-2xl font-bold text-foreground mb-4 mt-10">
                  Son parcours discographique et ses distinctions
                </h4>
                <p className="mb-4">
                  La carrière discographique de Baaba Maal s'étend sur plus de quatre décennies avec
                  une cinquantaine d'albums dont les plus emblématiques sont :
                </p>
                <ul className="list-disc pl-6 space-y-2 mb-6 marker:text-primary">
                  <li>
                    <strong>Djam Leelii (1984)</strong> — collaboration intime avec Mansour Seck,
                    considérée comme un chef-d'œuvre de la musique africaine acoustique
                  </li>
                  <li>
                    <strong>Baayo (1991)</strong> — album qui l'impose sur la scène internationale
                  </li>
                  <li>
                    <strong>Firin' in Fouta (1994)</strong> — production phare alliant sonorités
                    traditionnelles et world music
                  </li>
                  <li>
                    <strong>Missing You (Mi Yeewnii) (2001)</strong> — explorations électroniques
                  </li>
                  <li>
                    <strong>Television (2009)</strong> — album engagé sur les mutations sociales
                  </li>
                  <li>
                    <strong>The River (2017)</strong> — retour aux sources, dédié au fleuve Sénégal
                  </li>
                </ul>
                <p>
                  Parmi ses distinctions : Prix Kora de la Meilleure Musique Africaine, nomination
                  aux Grammy Awards, Ambassadeur de Bonne Volonté du PNUD, Chevalier de l'Ordre des
                  Arts et Lettres de France. Il a collaboré avec Peter Gabriel, Youssou N'Dour,
                  Damon Albarn (Gorillaz) et de nombreux artistes internationaux.
                </p>
              </div>

              <div>
                <h4 className="font-display text-2xl font-bold text-foreground mb-4 mt-10">
                  Son engagement pour la culture Pulaar
                </h4>
                <p className="mb-4">
                  Au-delà de sa carrière artistique, Baaba Maal s'est imposé comme un défenseur
                  infatigable de la culture et des langues du Fouta. Ses concerts, qu'ils se
                  tiennent à Londres, New York ou Podor, portent invariablement la langue Pulaar et
                  les sonorités du fleuve Sénégal. Il est co-fondateur du festival « Les Blues du
                  Fleuve » à Podor, devenu un rendez-vous culturel incontournable qui rassemble
                  artistes locaux et internationaux autour du patrimoine musical de la vallée.
                </p>
                <p>
                  Son projet de centre de recherche et de formation à Podor s'inscrit dans la
                  continuité logique de cet engagement : ancrer dans sa ville natale une institution
                  pérenne capable de former les générations futures aux musiques traditionnelles du
                  Fouta Toro.
                </p>
              </div>
            </div>
        ...
        <div className="container-page">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="mt-4 text-muted-foreground">
              Le complexe NANN-k est structuré autour de 8 pôles majeurs conçus pour préserver,
              créer et transmettre le patrimoine culturel.
            </p>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {espaces.map((espace, idx) => (
              <div
                key={idx}
                className="bg-background border border-border p-6 rounded-2xl hover:border-primary transition-colors group"
              >
                <div className="text-3xl font-display text-primary/30 group-hover:text-primary mb-4 transition-colors">
                  0{idx + 1}
                </div>
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-3">
          {instruments.map((inst) => {
            ...
            return (
              <article
                key={inst.nom}
                className="rounded-2xl border border-border bg-card overflow-hidden flex flex-col transition hover:border-primary"
              >
                <div className="aspect-square relative overflow-hidden">
                  ...
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(180deg, transparent, oklch(0.15 0.04 250 / 0.85))",
                    }}
                  />
      ...
      <div className="container-page py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 mb-12">
            ...
            <div className="max-w-3xl">
              ...
              <Link to="/blues-du-fleuve">
                <h2 className="font-display text-4xl md:text-5xl font-bold leading-[1.1] mb-4 group-hover:text-primary transition-colors text-foreground">
                  ...
                  <span className="text-primary italic">16ème édition</span> historique
                </h2>
              </Link>
              <p className="text-lg text-muted-foreground leading-relaxed mb-6 font-serif">
                « Les Rives de l'Harmonie » : c'est le thème choisi cette année par l'artiste Baaba
                Maal pour célébrer la culture, la sécurité, l'environnement et la solidarité. Un
                événement majeur pour le rayonnement international de Podor et de toute la région.
              </p>
              <Link
                to="/blues-du-fleuve"
                className="inline-flex items-center text-xs font-bold uppercase tracking-widest text-foreground hover:text-primary transition-colors border-b border-foreground hover:border-primary pb-1"
              >
          ...
          <div className="lg:col-span-4 flex flex-col gap-8">
            <div className="font-display text-2xl font-bold border-b border-border pb-2 uppercase text-foreground">
              En Continu
            </div>
            {articles.map((article, idx) => (
              <article
                key={idx}
                className="group flex flex-col gap-3 pb-6 border-b border-border last:border-0"
              >
      ...
      <section className="bg-muted border-y border-border py-16 mt-10">
        <div className="container-page">
          <div className="flex items-center justify-between mb-10 border-b-2 border-foreground pb-4">
            ...
            <Link
              to="/"
              className="text-sm font-semibold text-foreground hover:text-primary hidden sm:flex items-center uppercase tracking-wider text-[11px]"
            >
          ...
          <div className="grid md:grid-cols-2 gap-10 items-center">
            <div className="order-2 md:order-1 bg-background p-8 border border-border shadow-sm">
              ...
              <h3 className="font-display text-3xl font-bold mb-4 text-foreground leading-tight">
                Une stratégie de développement local ambitieuse
              </h3>
              <p className="text-muted-foreground mb-8 font-serif text-lg leading-relaxed">
                Le projet Nannka ne se limite pas à l'événementiel. À travers ses trois piliers (Le
                Festival, Nannka TV, et le Centre Culturel), il vise des objectifs concrets pour la
                période 2025-2026.
              </p>
        ...
        <div className="bg-foreground text-background p-10 md:p-16 max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-10">
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-background/70 font-serif leading-relaxed">
              Recevez chaque semaine une sélection de nos meilleurs articles, décryptages et
              reportages concernant le développement de la vallée.
            </p>
          </div>
