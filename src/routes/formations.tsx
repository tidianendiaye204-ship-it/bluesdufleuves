    ...
    <div className="bg-background min-h-screen">
      ...
      <section className="py-20 md:py-28 relative overflow-hidden">
        ...
        <div className="container-page text-center max-w-4xl mx-auto relative z-10">
          <div className="text-xs uppercase tracking-[0.3em] text-white/80 mb-4 font-bold">
            Apprentissage & Transmission
          </div>
          <h1 className="font-display text-4xl md:text-6xl font-bold mb-6 uppercase tracking-tight text-white">
        ...
        <div className="grid lg:grid-cols-12 gap-16 items-start">
            ...
            <div className="mb-12">
              ...
              <div className="font-serif text-muted-foreground text-lg leading-relaxed space-y-6">
                ...
                <p>
                  ...
                  qualité au <span className="text-foreground font-medium">The Village</span>.
                </p>
              </div>
          ...
          <div className="lg:col-span-5 bg-card border border-border p-8 md:p-10 rounded-3xl shadow-sm sticky top-32">
            ...
            <div className="mt-12 pt-8 border-t border-border text-center">
              <a
                href="#inscription"
                className="w-full inline-block btn-gradient-premium text-white font-bold uppercase tracking-widest px-8 py-4 text-sm rounded-xl shadow-lg"
              >
          ...
          <div className="bg-card border border-border p-8 md:p-10 rounded-3xl shadow-sm">
            {sent ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-2 btn-gradient-gold text-foreground font-bold uppercase tracking-widest px-8 py-4 text-sm rounded-xl shadow-lg"
                >
                  <Send size={16} />
