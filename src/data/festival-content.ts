import { Music2, Palette, Mic } from "lucide-react";
...
export const galleryImages = [
  ...
  { id: 2, src: "/festival baba maal.webp", alt: "Baaba Maal", span: "md:col-span-1 md:row-span-1", objectPosition: "center 10%" },
  ...
  { id: 6, src: "/centre-podor.webp", alt: "Centre Culturel", span: "md:col-span-1 md:row-span-1" },
  { id: 7, src: "/gal1.webp", alt: "Galerie 1", span: "md:col-span-1 md:row-span-1", objectPosition: "top" },
  { id: 8, src: "/gal2.webp", alt: "Galerie 2", span: "md:col-span-1 md:row-span-1" },
  { id: 9, src: "/gal3.webp", alt: "Galerie 3", span: "md:col-span-1 md:row-span-1" },
  { id: 10, src: "/gal4.webp", alt: "Galerie 4", span: "md:col-span-1 md:row-span-1" },
  { id: 11, src: "/gal5.webp", alt: "Galerie 5", span: "md:col-span-1 md:row-span-1" },
  { id: 12, src: "/gal6.webp", alt: "Galerie 6", span: "md:col-span-1 md:row-span-1" },
  { id: 13, src: "/gal7.webp", alt: "Galerie 7", span: "md:col-span-1 md:row-span-1", objectPosition: "top" },
  { id: 14, src: "/gal8.webp", alt: "Galerie 8", span: "md:col-span-1 md:row-span-1", objectPosition: "center 15%" },
  { id: 15, src: "/gal9.webp", alt: "Galerie 9", span: "md:col-span-1 md:row-span-1", objectPosition: "center 20%" },
];
