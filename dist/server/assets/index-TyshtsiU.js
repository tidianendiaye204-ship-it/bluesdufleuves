...
import { a as createLucideIcon, c as centreImg, L as Link, f as fleuveImg, g as soumettreNewsletter } from "./router-BSNIcf9f.js";
...
function Home() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-background min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed top-24 left-1/2 -translate-x-1/2 z-40 hidden md:block w-auto max-w-2xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass px-6 py-2 rounded-full border border-white/20 shadow-elegant flex items-center gap-4 animate-reveal", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-bold text-foreground/80 tracking-tight whitespace-nowrap overflow-hidden", children: "La 16ème édition des Blues du Fleuve annoncée sous le signe de l'intégration." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative h-[100vh] min-h-[700px] flex items-center justify-center overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-page relative z-10 text-center pt-32 md:pt-40", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 rounded-full border border-white/30 bg-white/10 backdrop-blur-md px-5 py-2 text-[10px] font-black uppercase tracking-[0.3em] text-white mb-10 animate-reveal", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "container-page py-32 border-b border-border/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-20 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[4/5] rounded-2xl overflow-hidden shadow-elegant animate-reveal", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: baabaImg, alt: "Baaba Maal", className: "h-full w-full object-cover" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "container-page py-24", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-[#0a0908] rounded-3xl p-12 md:p-20 text-center relative overflow-hidden", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto relative z-10", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { className: "flex flex-col md:flex-row gap-4 max-w-md mx-auto", onSubmit: handleNewsletter, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", disabled: newsletterStatus === "loading", className: "rounded-full bg-primary px-10 py-4 text-[11px] font-black uppercase tracking-widest text-white premium-button disabled:opacity-50", children: newsletterStatus === "loading" ? "..." : "S'abonner" })
        ] }),
        newsletterMsg && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `mt-6 text-[10px] font-bold uppercase tracking-widest ${newsletterStatus === "success" ? "text-emerald-500" : "text-red-500"}`, children: newsletterMsg })
      ] })
    ] }) })
  ] });
}
