...
import { a as createLucideIcon, c as centreImg, e as soumettreInscription } from "./router-DAiBuBm4.js";
import { i as instrumentsImg, P as Play } from "./instruments-CZyD66tn.js";
import { S, a as Send } from "./index-BqPRtP2N.js";
...
const baabaVideo = "https://raw.githubusercontent.com/tidianendiaye204-ship-it/bluesdufleuves/main/src/assets/baaba-maal-helping-francais-compressed.mp4";
const programmes = [{
  icon: Music,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-background min-h-screen", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "container-page py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-12 gap-16 items-start", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-7", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-12", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-video overflow-hidden border-4 border-background shadow-xl mt-10 relative", children: isVideoPlaying ? /* @__PURE__ */ jsxRuntimeExports.jsx("video", { src: baabaVideo, controls: true, autoPlay: true, className: "w-full h-full object-cover", onEnded: () => setIsVideoPlaying(false) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: instrumentsImg, alt: "Apprentissage des instruments", className: "w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-700" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-black/40 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setIsVideoPlaying(true), className: "inline-flex h-20 w-20 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-(--shadow-glow) hover:scale-105 transition cursor-pointer", "aria-label": "Lecture vidéo", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Play, { size: 28, className: "ml-1", fill: "currentColor" }) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-4 left-4 right-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white text-sm font-bold bg-black/60 backdrop-blur-sm px-4 py-2 rounded-lg", children: "Baaba Maal — Formation des Artistes" }) })
        ] }) })
      ] }) }),
