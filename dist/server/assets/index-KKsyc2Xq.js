...
import { a as createLucideIcon, c as centreImg, L as Link, f as fleuveImg, g as soumettreNewsletter } from "./router-DAiBuBm4.js";
...
function Home() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-background min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
      ...
      duration: 0.8,
      ease: [0.16, 1, 0.3, 1]
    }, className: "fixed top-24 left-1/2 -translate-x-1/2 z-40 hidden md:block w-auto max-w-2xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass px-6 py-2 rounded-full border border-white/20 shadow-elegant flex items-center gap-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative h-screen min-h-175 flex items-center justify-center overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.img, { src: centreImg, alt: "Centre Culturel de Podor", className: "h-full w-full object-cover scale-105", animate: {
          y: [0, -10, 0]
        }, transition: {
          duration: 6,
          ease: "easeInOut",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-linear-to-b from-black/20 via-transparent to-background" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-page relative z-10 text-center pt-32 md:pt-40", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
          ...
          duration: 0.8,
          ease: [0.16, 1, 0.3, 1]
        }, className: "inline-flex items-center gap-2 rounded-full border border-white/30 bg-white/10 backdrop-blur-md px-5 py-2 text-[10px] font-black uppercase tracking-[0.3em] text-white mb-8", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.h1, { initial: {
          ...
          delay: 0.2,
          ease: [0.16, 1, 0.3, 1]
        }, className: "luxury-text text-6xl md:text-9xl text-white mb-8", children: [
          "The ",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(motion.p, { initial: {
          ...
          delay: 0.4,
          ease: [0.16, 1, 0.3, 1]
        }, className: "mt-6 max-w-2xl mx-auto text-lg md:text-xl text-white/80 font-medium leading-relaxed", children: "L'épicentre culturel de la vallée du fleuve. Un complexe unique regroupant musée, espaces de création et de formation." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
          opacity: 0,
          y: 20
        }, animate: {
          ...
          delay: 0.6,
          ease: [0.16, 1, 0.3, 1]
        }, className: "mt-12 flex flex-col md:flex-row items-center justify-center gap-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "container-page py-32 border-b border-border/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-20 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-3/4 rounded-2xl overflow-hidden shadow-elegant", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-linear-to-t from-black/70 via-black/10 to-transparent" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-muted/30 py-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-page", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-10", children: articles.map((article, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { initial: {
        opacity: 0,
        y: 50
      }, whileInView: {
        opacity: 1,
        ...
        delay: idx * 0.15,
        ease: [0.16, 1, 0.3, 1]
      }, className: "h-full", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: article.to, className: "group flex flex-col h-full bg-background rounded-2xl overflow-hidden shadow-elegant hover:-translate-y-2 transition-all duration-500", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "container-page py-32", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-3 gap-12", children: instruments.map((inst, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
        opacity: 0,
        y: 30
      }, whileInView: {
        opacity: 1,
        ...
        delay: idx * 0.1,
        ease: [0.16, 1, 0.3, 1]
      }, className: "p-10 rounded-2xl border border-border/10 bg-muted/20 hover:bg-background hover:shadow-elegant transition-all duration-500", children: [
