...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-J_e6W9W6.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BBT351A8.js").then((n2) => n2.r),
    import("./start-D3LQ2mN5.js"),
...
export {
  ...
  isInlinableStylesheet as C,
  DEFAULT_PROTOCOL_ALLOWLIST as D,
  isModuleNotFoundError as E,
  isNotFound as F,
  isPromise as G,
  isRedirect as H,
  isServer as I,
  ...
  last as L,
  matchContext as M,
  nullReplaceEqualDeep as N,
  Outlet as O,
  parseHref as P,
  processRouteMasks as Q,
  React as R,
  processRouteTree as S,
  TSS_SERVER_FUNCTION as T,
  reactExports as U,
  redirect as V,
  removeTrailingSlash as W,
  replaceEqualDeep as X,
  requireReact as Y,
  requireReactDom as Z,
  resolveManifestAssetLink as _,
  arraysEqual as a,
  rewriteBasepath as a0,
  rootRouteId as a1,
  server as a2,
  setCookie$1 as a3,
  trimPath as a4,
