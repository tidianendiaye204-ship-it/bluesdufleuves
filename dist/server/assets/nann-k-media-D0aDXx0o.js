...
import { P as Play, i as instrumentsImg } from "./instruments-BC0WPiIW.js";
import { p as piroguesImg } from "./pirogues-BR-IZ-pT.js";
import { f as fleuveImg, d as logoNannk, b as crowdImg, X } from "./router-BmkHrY00.js";
...
function NannkMedia() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-background min-h-screen", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "container-page py-20 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-16 items-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-4/3 overflow-hidden border-4 border-background shadow-xl group", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: fleuveImg, alt: "NANN-K Mission", className: "w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-1000 scale-105 group-hover:scale-100" }) }) })
    ] }) }),
