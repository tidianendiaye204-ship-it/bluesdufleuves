...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-QykGDyCM.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-CcYlegPB.js").then((n2) => n2.r),
    import("./start-BKgb301v.js"),
...
export {
  ...
  invariant as B,
  isDangerousProtocol as C,
  DEFAULT_PROTOCOL_ALLOWLIST as D,
  isInlinableStylesheet as E,
  isModuleNotFoundError as F,
  isNotFound as G,
  isPromise as H,
  isRedirect as I,
  isServer as J,
  joinPaths as K,
  jsxRuntimeExports as L,
  last as M,
  matchContext as N,
  Outlet as O,
  nullReplaceEqualDeep as P,
  parseHref as Q,
  React as R,
  processRouteMasks as S,
  TSS_SERVER_FUNCTION as T,
  processRouteTree as U,
  reactExports as V,
  redirect as W,
  removeTrailingSlash as X,
  replaceEqualDeep as Y,
  requireReact as Z,
  requireReactDom as _,
  arraysEqual as a,
  resolvePath as a0,
  rewriteBasepath as a1,
  rootRouteId as a2,
  server as a3,
  setCookie$1 as a4,
  trimPath as a5,
