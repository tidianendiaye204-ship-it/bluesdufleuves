import { U as reactExports, K as jsxRuntimeExports } from "./server-S6Z8VJ19.js";
import { P as Play, i as instrumentsImg } from "./instruments-CZyD66tn.js";
import { p as piroguesImg } from "./pirogues-BR-IZ-pT.js";
import { d as logoNannk, f as fleuveImg, b as crowdImg, X } from "./router-DAiBuBm4.js";
import "node:async_hooks";
import "node:stream/web";
import "node:stream";
import "./styles-VxOLxp0f.js";
import "./types-DGfzljZx.js";
const agri1Img = "/assets/nann-k-agri1-CefDljio.jpg";
const agri2Img = "/assets/nann-k-agri2-CiniwdYR.jpg";
const agri3Img = "/assets/nann-k-agri3-BUGZqT5R.jpg";
const agri4Img = "/assets/nann-k-agri4-6L3ZLtYq.jpg";
const agri5Img = "/assets/nann-k-agri5-C-OhXjEj.jpg";
const agri6Img = "/assets/nann-k-agri6-ChjMKfiZ.jpg";
const agri7Img = "/assets/nann-k-agri7-CUvGYULu.jpg";
const agri8Img = "/assets/nann-k-agri8-NqIEPeFr.jpg";
...
function NannkMedia() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-background min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-muted border-b border-border py-16 md:py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-page text-center max-w-4xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs uppercase tracking-[0.3em] text-primary mb-4 font-bold", children: "Mouvement Culturel & Économique" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg md:text-xl font-serif text-muted-foreground leading-relaxed", children: `Le mouvement "NANN-K" est né de la volonté de l'artiste Baaba MAAL de répondre par une participation effective à l'invitation des plus hautes autorités à la réalisation de la croissance de l'économie, et donc le progrès social, au Sénégal puis progressivement en Afrique surtout au Sud du Sahara. Cette région concentre les États à faible revenu de l'Afrique de l'Ouest, ce qui représente un empêchement pour accélérer la croissance, éliminer la pauvreté et la faim dans les pays.` })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "container-page py-20 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-16 items-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-widest text-primary mb-3 block font-bold", children: "Le Fondateur" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif text-muted-foreground mb-6 text-lg leading-relaxed", children: "NANNK apporte une nouvelle dynamique active et citoyenne de promotion de l'Agriculture au sens large, l'Artisanat et les Technologies modernes (TIC). Ces secteurs à fort potentiel offrent des conditions d'un plein épanouissement et d'une participation effective à la construction du tissu économique." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif text-muted-foreground mb-6 text-lg leading-relaxed", children: `Dans le langage Peulh, "NANN-K" est une expression populaire qui est utilisée pour la plaisanterie et provient du verbe «nanni» c'est à dire Ouïr. C'est pour cette raison que le mouvement possède un bras culturel constitué par une troupe folklorique afin de faire entendre et comprendre les opérations du développement, dans la musique et la mobilisation.` }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif text-muted-foreground mb-8 text-lg leading-relaxed", children: `Donc, le mouvement "NANN-K" se veut asseoir une conscientisation, motivation médiatisée pour l'application par responsabilité citoyenne, du triptyque «Culture – Savoir – Travail » afin de réaliser le développement de l'Agriculture, l'Artisanat et les Technologies en faveur d'une réelle Emergence sociale et économique.` }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 font-serif text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "block text-foreground mb-1 font-sans uppercase tracking-wider text-xs", children: "Agriculture" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: "Promotion de l'agriculture au sens large pour la sécurité alimentaire et la croissance économique." })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-primary w-2 h-2 rounded-full mt-2.5 shrink-0 shadow-[0_0_8px_var(--color-primary)]" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "block text-foreground mb-1 font-sans uppercase tracking-wider text-xs", children: "Artisanat" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: "Valorisation du savoir-faire artisanal local et création d'opportunités économiques." })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-primary w-2 h-2 rounded-full mt-2.5 shrink-0 shadow-[0_0_8px_var(--color-primary)]" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "block text-foreground mb-1 font-sans uppercase tracking-wider text-xs", children: "Technologies (TIC)" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: "Intégration des technologies modernes pour accélérer le développement et l'innovation." })
            ] })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-4/3 overflow-hidden border-4 border-border shadow-xl group rounded-2xl bg-white flex items-center justify-center p-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logoNannk, alt: "Logo NANN-K", className: "max-w-full max-h-full object-contain group-hover:scale-110 transition-transform duration-1000" }) }) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "container-page py-20 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-widest text-primary mb-3 block font-bold", children: "Contexte & Justification" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl font-bold mb-8 uppercase tracking-tight text-foreground", children: "Pourquoi NANN-K ?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "prose prose-lg max-w-none space-y-6 font-serif text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Le développement social et économique en Afrique fait face à des défis majeurs. Le manque d'initiatives citoyennes et de réflexions approfondies sur les stratégies pour un avenir meilleur constitue un obstacle important." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "La réponse insuffisante des gouvernements à la demande d'emploi, à la création de richesses et à la sécurité alimentaire nécessite une mobilisation citoyenne accrue." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: `Avec la fin de l'initiative "Afrique 2015" et des Objectifs du Millénaire pour le Développement, de nombreux émigrants sont contraints de retourner dans leurs pays d'origine en raison des crises européennes.` }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Le Sénégal a décidé de faire de l'agriculture un moteur de croissance, mais les mesures institutionnelles ralentissent sa mise en œuvre. La population a besoin d'alternatives, notamment pour accéder à des informations utiles et au financement, acquérir des équipements et des intrants, et bénéficier de renforcement des capacités." })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "container-page py-20 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs uppercase tracking-widest text-primary mb-3 block font-bold", children: "Agriculture NANN-K" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-3xl font-bold mb-8 uppercase tracking-tight text-foreground", children: "Nos Projets Agricoles" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif text-muted-foreground mb-8 text-lg leading-relaxed", children: "Découvrez nos initiatives agricoles dans la vallée du fleuve Sénégal." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-6 md:grid-cols-2 lg:grid-cols-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-4/3 rounded-2xl overflow-hidden border border-border group", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: agri1Img, alt: "Agriculture NANN-K 1", className: "w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-4/3 rounded-2xl overflow-hidden border border-border group", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: agri2Img, alt: "Agriculture NANN-K 2", className: "w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-4/3 rounded-2xl overflow-hidden border border-border group", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: agri3Img, alt: "Agriculture NANN-K 3", className: "w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-4/3 rounded-2xl overflow-hidden border border-border group", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: agri4Img, alt: "Agriculture NANN-K 4", className: "w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-4/3 rounded-2xl overflow-hidden border border-border group", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: agri5Img, alt: "Agriculture NANN-K 5", className: "w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-4/3 rounded-2xl overflow-hidden border border-border group", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: agri6Img, alt: "Agriculture NANN-K 6", className: "w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-4/3 rounded-2xl overflow-hidden border border-border group", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: agri7Img, alt: "Agriculture NANN-K 7", className: "w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-4/3 rounded-2xl overflow-hidden border border-border group", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: agri8Img, alt: "Agriculture NANN-K 8", className: "w-full h-full object-cover transition-transform duration-500 group-hover:scale-105" }) })
      ] })
    ] }) }),
