...
import { g as getDb, w as withRetry } from "./db-BZ2-xBa0.js";
import { c as contacts } from "./schema-BzPAZZ25.js";
import { i as createServerFn } from "./server-co7iUJes.js";
import { o as objectType, s as stringType, b as booleanType } from "./types-DLNE6-nO.js";
...
const soumettreContact = createServerFn({
  method: "POST"
}).inputValidator((data) => contactSchema.parse(data)).outputValidator(objectType({
  success: booleanType(),
  message: stringType()
})).handler(soumettreContact_createServerFn_handler, async ({
  data,
  context
}) => {
